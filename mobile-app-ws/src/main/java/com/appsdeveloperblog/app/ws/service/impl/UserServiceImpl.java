...
public class UserServiceImpl implements UserService {
	...
	public UserDto createUser(UserDto user) {
		...
		// Set additional fields ... not part of UI request object ... 
         ...
         * several parameters / fields that are created (on execution of buisness logic) ....
         * These fields may not be part of DB table,so we have entity class which which captures
         * only the fields (from DTO), generated during buisness operation and should be part of DB 
         * table field
         * 
         */
